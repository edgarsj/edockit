...
describe("XMLCanonicalizer", () => {
  ...
  describe("canonicalization fixtures", () => {
    ...
    it("should correctly canonicalize a signature fragment", () => {
      ...
      const node = querySelector(doc, "ds:SignedInfo");
      const expectedC14n =
    ...
    it("should correctly retain whitespace 1 c14n", async function () {
      ...
      const expectedC14n11 = await fetchSample("whitespace1_c14n.xml");
      ...
      expect(XMLCanonicalizer.c14n11(doc.documentElement as any)).to.equal(expectedC14n11);
    });
